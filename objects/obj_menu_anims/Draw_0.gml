var bebo_y = bomb_y - (bomb_scale * (bomb_y / 3));
...
draw_sprite_ext(spr_menu_title, 0, title_x, title_y, 1, 1, 0, c_white, 1);
...
draw_text(title_x, title_y- (sprite_get_height(spr_menu_title) / 2), "Title");
